...
public class XForm : Form
{
    ...
    private void CreateHoveringImages()
    {
        ...
        Color cStart = CommonUtility.GetLighterColor(_titleBarStartColor.ToSharedColor()).ToDrawingColor();
        Color cEnd = CommonUtility.GetLighterColor(_titleBarEndColor.ToSharedColor()).ToDrawingColor();
    ...
    private void CreateHoldingImages()
    {
        ...
        Color cStart = CommonUtility.GetDeeperColor(_titleBarStartColor.ToSharedColor()).ToDrawingColor();
        Color cEnd = CommonUtility.GetDeeperColor(_titleBarEndColor.ToSharedColor()).ToDrawingColor();
