...
/// <summary>
/// 表示<see cref="LoadingCircle"/>中的一个"点"
/// </summary>
internal sealed class Dot
{
    ...
    /// 透明度
    /// </summary>
    public int Opacity => _opacity < MIN_OPACITY 
        ? MIN_OPACITY 
    ...
    {
        Location = GeometryUtility.GetLocationByAngle(_circleCenter.ToSharedPoint(), _circleRadius, _angle).ToDrawingPointF();
    }
