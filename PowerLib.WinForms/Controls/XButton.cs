...
using PowerLib.WinForms.Utilities;
...
public sealed class XButton : Control, IButtonControl
{
    ...
    public Color StartColor
    {
        ...
        {
            _startColor = value;
            _hoveringStartColor = CommonUtility.GetLighterColor(value.ToSharedColor()).ToDrawingColor();
            Refresh();
        }
    }
    ...
    public Color EndColor
    {
        ...
        {
            _endColor = value;
            _hoveringEndColor = CommonUtility.GetLighterColor(value.ToSharedColor()).ToDrawingColor();
            Refresh();
        }
    }
    ...
    public Color CheckedStartColor
    {
        ...
        set
        {
            ...
            _hoveringCheckedStartColor = CommonUtility.GetLighterColor(value.ToSharedColor()).ToDrawingColor();
            _holdingCheckedStartColor = CommonUtility.GetDeeperColor(value.ToSharedColor()).ToDrawingColor();
            Refresh();
        }
    }
    ...
    public Color CheckedEndColor
    {
        ...
        set
        {
            ...
            _hoveringCheckedEndColor = CommonUtility.GetLighterColor(value.ToSharedColor()).ToDrawingColor();
            _holdingCheckedEndColor = CommonUtility.GetDeeperColor(value.ToSharedColor()).ToDrawingColor();
            Refresh();
        }
    }
    ...
    public char Shortcut
    {
        ...
        set
        {
            ...
            // 绑定快捷键响应
            Form parentForm = WinFormsUtility.GetParentForm(this);
            if (parentForm == null)
                return;
    ...
    private void DrawBackgroundAndBorder(Graphics g)
    {
        ...
        {
            gPath = GraphicsPathUtility.GetRoundedRectPath(DisplayRectangle, _roundedRectangleCornerRadius);
            Region = new Region(GraphicsPathUtility.GetRoundedRectPath(DisplayRectangle,
    ...
    protected override void OnMouseClick(MouseEventArgs e)
    {
        ...
        Form parent = WinFormsUtility.GetParentForm(this);
