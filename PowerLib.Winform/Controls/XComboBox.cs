...
namespace PowerLib.Winform.Controls
{
    ...
    public sealed partial class XComboBox : ComboBox
    {
        ...
        private Color _borderColorHighLight = Color.FromArgb(66, 215, 250);
        ...
        // 高亮边框画笔
        private Pen _penBorderColorHighLight;
        // 前景画刷
        ...
        // 高亮下拉箭头画刷
        private SolidBrush _brsArrowHighLight;
        // 禁用状态背景画刷
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            using (Graphics g = Graphics.FromHdc(hDc))
            {
                ...
                // 边框
                ControlPaint.DrawBorder(g, rect, _borderHighLight ? _borderColorHighLight : _borderColor, _borderStyle);
                // 背景
                ...
                // 下拉箭头
                g.FillPolygon(_borderHighLight ? _brsArrowHighLight : _brsArrow, new[]
                {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(_borderHighLight ? _penBorderColorHighLight : _penBorderColor, rect);
